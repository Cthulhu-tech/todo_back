...
app.use(cors({origin: "https://todo-react-type.herokuapp.com/", credentials: true, optionSuccessStatus: 204, headers: "Access-Control-Allow-Headers, Origin, X-Requested-With, Content-Type, Accept, Authorization"}));
